          ...
          <div className="w-full max-w-lg bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="relative">
                  <input
                    ...
                    placeholder=" "
                    className="peer w-full bg-white/5 border border-white/20 rounded-lg px-4 pt-5 pb-2 pr-10 text-white text-sm outline-none focus:border-[#0fb2ff] transition-colors placeholder-transparent"
                  />
                  <label className="absolute left-4 top-1.5 text-[10px] text-gray-400 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-focus:top-1.5 peer-focus:text-[10px] peer-focus:text-[#0fb2ff] transition-all pointer-events-none">
                    Password
                  </label>
              ...
              <select
                ...
                className="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white text-sm outline-none focus:border-[#0fb2ff] transition-colors [&>option]:text-black"
              >
